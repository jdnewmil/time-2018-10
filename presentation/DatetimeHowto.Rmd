...
- Date/Time values make messy plots?
...
```{r}
dta <- read.csv( "../data/MAC000002clean.csv", as.is=TRUE ) # avoid auto-convert to factor
dta$Dtm <- as.POSIXct( dta$DateTime )
# or just
# dta <- readr::read_csv( "../data/MAC000002clean.csv" )
str(dta)
plot( dta$Dtm, dta$KWH, pch = "." )
```
